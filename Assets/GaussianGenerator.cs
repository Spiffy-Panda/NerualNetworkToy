...
public class GaussianGenerator {
  ...
  public float3 NextFloat3() => new float3(NextFloat2(), NextFloat1());
  public float4 NextFloat4() => new float4(NextFloat2(), NextFloat2());

  public float4x4 NextFloat4x4() => new float4x4(NextFloat4(), NextFloat4(), NextFloat4(), NextFloat4());
  public float3x4 NextFloat3x4() => new float3x4(NextFloat3(), NextFloat3(), NextFloat3(), NextFloat3());
  public float2x4 NextFloat2x4() => new float2x4(NextFloat2(), NextFloat2(), NextFloat2(), NextFloat2());

  public float4x3 NextFloat4x3() => new float4x3(NextFloat4(), NextFloat4(), NextFloat4());
  public float3x3 NextFloat3x3() => new float3x3(NextFloat3(), NextFloat3(), NextFloat3());
  public float2x3 NextFloat2x3() => new float2x3(NextFloat2(), NextFloat2(), NextFloat2());

  public float4x2 NextFloat4x2() => new float4x2(NextFloat4(), NextFloat4());
  public float3x2 NextFloat3x2() => new float3x2(NextFloat3(), NextFloat3());
  public float2x2 NextFloat2x2() => new float2x2(NextFloat2(), NextFloat2());
  
  public static void TestGaussian()
  {

    var t = math.sqrt(-2.0f * math.log(UnityEngine.Random.value)) * math.cos(UnityEngine.Random.value);
    Debug.Log(t);
